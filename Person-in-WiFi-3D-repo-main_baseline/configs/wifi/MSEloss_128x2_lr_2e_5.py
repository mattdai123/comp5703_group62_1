...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_contrastive=dict(type='opera.ContrastiveLoss', margin=1.0, loss_weight=1.0)),
    train_cfg=dict(
...
work_dir = "/mnt/d/wifipose_dataset/result/mse1282/"
# resume_from = '/home/qianbo/wifipose/opera-main/result/wifipose/latest.pth'